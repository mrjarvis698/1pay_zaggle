...
try:
  ...
  for x in range (0 , total_input_rows):
    for z in range (0, int(settings_data['equitas_no.of_transation_per_card'])):
      cc_expiry()
      start_link()
      main()
      output_save()
  ...
  for x in range (last_txncard , total_input_rows):
    for z in range (int(done_transactions_wb[h]), int(settings_data['equitas_no.of_transation_per_card'])):
      cc_expiry()
      start_link()
      main()
      output_save()
